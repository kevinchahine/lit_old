...
namespace lit
{
	...
	namespace devices
	{
		...
		public: // --------------------------- Public Methods ------------------------
			...
			unique_ptr<scene::SceneBase>& scenePtr() { return p_scenePtr; }
			const unique_ptr<scene::SceneBase>& scenePtr() const { return p_scenePtr; }
		...
		protected: // ------------------------ Protected Fields ----------------------
			...
			unique_ptr<scene::SceneBase> p_scenePtr = make_unique<scene::SceneBase>();
			rgb m_currentColor;
		};
	}
}
